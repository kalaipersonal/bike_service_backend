...
import { Enduserregiter } from '../../services/login_services/Login_services';
import { useNavigate } from 'react-router-dom';
function EnduserRegister() {
    ...
    const onFinish = async (values) => {
        ...
        try {
            const response = await Enduserregiter(datas);
            ToastMessageSuccess("Register Successfully");
            setTimeout(() => {
                navigate("/");
            }, 700);
        }
